...
Its simplicity and flexibility allows it to produce robust estimates of future possible climate outcomes within minutes, even for scenarios that haven't been represented by ESMs. The current MESMER analyses are based on [Beusch et al. (2020)](https://esd.copernicus.org/articles/11/139/2020/) and [Beusch et al. (2022)](https://gmd.copernicus.org/articles/15/2085/2022/gmd-15-2085-2022.html); for a full description of the data see Schwaab et al. (in preparation). For further information see [here](https://mesmer-emulator.readthedocs.io/en/latest/).
